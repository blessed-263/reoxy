...
export const MICOR_DEFAULT_CHECK_IN =
...
export const MICOR_DEFAULT_BAGGAGE =
  'Зарегистрированный багаж: 1–2 места до 23 кг (эконом-класс) или до 32 кг (бизнес-класс), сумма трех измерений каждого места не должна превышать 158 см. Ручная кладь: 1 место до 8 кг (55×40×23 см). Внешние аккумуляторы (Power Bank), электронные сигареты и запасные литиевые батареи разрешено провозить ИСКЛЮЧИТЕЛЬНО в ручной клади; их сдача в багаж категорически запрещена правилами ICAO/IATA.';

export const MICOR_DEFAULT_VISA =
...
export const MICOR_DEFAULT_FARE =
...
export const MICOR_DEFAULT_BOARDING = 'Гейт закрывается за 20 мин до вылета.';
...
export const createEmptyItinerary = (): Itinerary => {
  ...
  return {
    ...
    amountPaid: 64200,
    baggagePolicy: MICOR_DEFAULT_BAGGAGE,
    checkInPolicy: MICOR_DEFAULT_CHECK_IN,
    visaPolicy: MICOR_DEFAULT_VISA,
    farePolicy: MICOR_DEFAULT_FARE,
    boardingPolicy: '',
    importantNotes: [
