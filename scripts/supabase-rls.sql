...
ALTER TABLE IF EXISTS portal_profiles ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS portal_quotes ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS portal_quote_items ENABLE ROW LEVEL SECURITY;
REVOKE ALL ON TABLE portal_profiles FROM anon, authenticated;
REVOKE ALL ON TABLE portal_quotes FROM anon, authenticated;
REVOKE ALL ON TABLE portal_quote_items FROM anon, authenticated;
